  ...
  $ \.zoom-graph .each ->
    ...
    */
    ...
    ``
  		...
  		var plot = $.plot('#' + actor.actor-id, startData, options);
  		...
  		$('#' + actor.actor-id).bind("plotselected", function (event, ranges) {
  			...
  			plot = $.plot('#' + actor.actor-id, getData(ranges.xaxis.from, ranges.xaxis.to),
  				$.extend(true, {}, options, {
