...
function LongPolling(n){var e;e=this,this.settings=n,this.http=require("http"),this.content={node:n.id},this.events={error:[],data:[],receive:[],connect:[],disconnect:[],code:[]}}var ref$,sleep,waitFor,timeoutWaitFor,go,merge,unpack,pack,repl,config,Wifi,connectToWifi,onInit,slice$=[].slice;ref$=require("aea"),sleep=ref$.sleep,waitFor=ref$.waitFor,timeoutWaitFor=ref$.timeoutWaitFor,go=ref$.go,merge=ref$.merge,unpack=ref$.unpack,pack=ref$.pack,repl=ref$.repl,config=ref$.config,Wifi=require("Wifi"),LongPolling.prototype.mkOpts=function(n,e){var t;return t={host:this.settings.host,port:this.settings.port,path:this.settings.path,method:this.settings.method,headers:{"Content-Type":"application/json","Content-Length":pack(n).length}},e&&(t=merge(t,e)),t},LongPolling.prototype.trigger=function(n){var e,t,o,r,i,c=[];for(e=slice$.call(arguments,1),t=0,i=(r=this.events[n]).length;i>t;++t)o=r[t],"function"==typeof o&&c.push(o.apply(this,e));return c},LongPolling.prototype.send=function(){var n,e,t,o,r;return e=0<(n=arguments.length-1)?slice$.call(arguments,0,n):(n=0,[]),t=arguments[n],o=e[0],r=e[1],this.sendRaw({data:o},r,t)},LongPolling.prototype.sendAck=function(n){return this.sendRaw({ack:"Mahmut"},n)},LongPolling.prototype.sendRaw=function(){var n,e,t,o,r,i,c,s,u;return e=0<(n=arguments.length-1)?slice$.call(arguments,0,n):(n=0,[]),t=arguments[n],o=this,r=e[0],i=e[1],c=merge(r,this.content),s=i?this.mkOpts(c,i):this.mkOpts(c),console.log("--------------------"),u=this.http.request(s,function(n){return n.on("data",function(n){var e;if(e=unpack(n),console.log("RESPONSE DATA HTTP> ",e),console.log("http data: ",e.data),e.code){o.trigger("code",e.code);try{t()}catch(r){}}if(e.ack)try{t()}catch(r){}if(e.data)try{return t()}catch(r){}}),n.on("error",function(){return console.log("Error:... WTF")}),n.on("close",function(){return console.log("Request is closed by server..")})}),u.on("error",function(n){return o.trigger("error",n,t),t(n.message)}),u.write(pack(c)),u.end(),console.log(process.memory())},LongPolling.prototype.connect=function(n){var e;return e=this,this.sendAck(function(t){return t?(console.log("Trying to connect again (2s)..."),sleep(1e3,function(){return e.connect(n)})):(console.log("Connect function run correctly.."),n(),sleep(2e3,function(){return function n(t){return console.log("!!!!!!Receiver is starting asyncronously.."),e.send({data:"I am receiver"},{path:"/receive"},function(e){return e?console.log("Receiver error: ",e):(console.log("Burasi..."),sleep(4e3,function(){return n(t)}))})}(function(){})}))})},LongPolling.prototype.on=function(n,e){var t;return(t=this.events)[n]=t[n].concat(e)},connectToWifi=function(n){return function(){var e,t,o,r,i;try{if(e=config.read(setting.wifi),t=e.essid,void 0===t)throw null;o=e.passwd,r=e.health}catch(c){i=c,t="aea",o="084DA789BF",r=-1,console.log("Using default ESSID: ",t)}return function s(n){return Wifi.scan(function(e){var o,r,i;for(o=0,r=e.length;r>o;++o)if(i=e[o],console.log("Found ESSID: ",i.ssid),i.ssid===t)return n();return console.log("ESSID '{"+t+"}' not found, searching again..."),sleep(2e3,function(){return s(n)})})}(function(){return function e(n){return console.log("trying to connect to wifi..."),Wifi.connect(t,{password:o},function(t){var o;if(console.log("connected? err=",t,"info",Wifi.getIP()),null===t)try{return n()}catch(r){o=r,console.log("WTF:",o)}sleep(5e3,function(){return e(n)})})}(function(){return"function"==typeof n?n():void 0})})}(function(){})},onInit=function(){return connectToWifi(function(){var comm,x$;return comm=new LongPolling({host:"192.168.2.107",id:"abc123",port:5656,path:"/send",method:"POST"}),x$=comm,x$.on("receive",function(n){return console.log("I received following data: ",n)}),x$.on("error",function(n){return console.log("COMM-ERR::: ",n.message)}),x$.on("connect",function(n){return console.log("Connected to server!!! Server info: ",n)}),x$.on("disconnect",function(){return console.log("Disconnected from server!")}),x$.on("code",function(code){eval(code);try{return console.log("X is: ",x)}catch(e$){}}),comm.connect(function(){return console.log("following code is starting..."),sleep(1e3,function(){return function n(e){return comm.send({temperature:Math.random()},function(t){return t&&console.log("We couldn't send data!"),timeoutWaitFor(1e4,"temperature-measured",function(){return n(e)})})}(function(){})})})})};
