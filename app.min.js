...
function LongPolling(n){var o;o=this,this.settings=n,this.http=require("http"),this.content={node:n.id},this.events={error:[],data:[],receive:[],connect:[],disconnect:[],code:[]}}var ref$,sleep,waitFor,timeoutWaitFor,go,merge,unpack,pack,repl,config,Wifi,connectToWifi,loadCode,onInit,slice$=[].slice;ref$=require("aea"),sleep=ref$.sleep,waitFor=ref$.waitFor,timeoutWaitFor=ref$.timeoutWaitFor,go=ref$.go,merge=ref$.merge,unpack=ref$.unpack,pack=ref$.pack,repl=ref$.repl,config=ref$.config,Wifi=require("Wifi"),connectToWifi=function(n){return function(){var o,e,t,r,i;try{if(o=config.read(setting.wifi),e=o.essid,void 0===e)throw null;t=o.passwd,r=o.health}catch(c){i=c,e="aea",t="084DA789BF",r=-1,console.log("Using default ESSID: ",e)}return function s(n){return Wifi.scan(function(o){var t,r,i;for(t=0,r=o.length;r>t;++t)if(i=o[t],console.log("Found ESSID: ",i.ssid),i.ssid===e)return n();return console.log("ESSID '{"+e+"}' not found, searching again..."),sleep(2e3,function(){return s(n)})})}(function(){return function o(n){return console.log("trying to connect to wifi..."),Wifi.connect(e,{password:t},function(e){var t;if(console.log("connected? err=",e,"info",Wifi.getIP()),null===e)try{return n()}catch(r){t=r,console.log("WTF:",t)}sleep(5e3,function(){return o(n)})})}(function(){return"function"==typeof n?n():void 0})})}(function(){})},LongPolling.prototype.mkOpts=function(n,o){var e;return e={host:this.settings.host,port:this.settings.port,path:this.settings.path,method:this.settings.method,headers:{"Content-Type":"application/json","Content-Length":pack(n).length}},o&&(e=merge(e,o)),e},LongPolling.prototype.trigger=function(n){var o,e,t,r,i,c=[];for(o=slice$.call(arguments,1),e=0,i=(r=this.events[n]).length;i>e;++e)t=r[e],"function"==typeof t&&c.push(t.apply(this,o));return c},LongPolling.prototype.send=function(n,o){return this.sendRaw({data:n},o)},LongPolling.prototype.sendAck=function(n){return this.sendRaw({ack:"Mahmut"},n)},LongPolling.prototype.sendRaw=function(n,o){var e,t,r,i,c;return e=this,t=merge(n,this.content),r=this.mkOpts(t),console.log("--------------------"),i=Math.floor(1e3*Math.random()+1),console.log("New Request: ",i),c=this.http.request(r,function(n){return n.on("data",function(n){var e;if(e=unpack(n),console.log("Resp id: "+i+" HTTP> ",e),e.ack)try{o()}catch(t){}if(e.data)try{return o()}catch(t){}}),n.on("error",function(){return console.log("Error: "+i+" ... WTF")}),n.on("close",function(){return console.log("Request: "+i+" closed by server..")})}),c.on("error",function(n){return e.trigger("error",n,o),o(n.message)}),c.write(pack(t)),c.end(),console.log(process.memory())},loadCode=void 0,LongPolling.prototype.sendGet=function(n){var o,e,t,r,i;return o=this,e=merge(n,this.content),t={host:"192.168.2.107",id:"abc123",port:5656,path:"/receive"},r=t,i=this.http.get(r,function(n){return n.on("data",function(n){return console.log("Get function got data: ",n,typeof n,n.length),loadCode=n})})},LongPolling.prototype.connect=function(n){var o;return o=this,this.sendAck(function(e){return e?(console.log("Trying to connect again (2s)..."),sleep(1e3,function(){return o.connect(n)})):(console.log("Connect function run correctly.."),n(),function t(n){return console.log("Receiver is starting asyncronously.."),o.sendGet(function(o){return console.log("ARR: ",o),o?void 0:(console.log("Burasi..."),sleep(1e4,function(){return t(n)}))})}(function(){}))})},LongPolling.prototype.on=function(n,o){var e;return(e=this.events)[n]=e[n].concat(o)},onInit=function(){return connectToWifi(function(){var comm,x$;return comm=new LongPolling({host:"192.168.2.107",id:"abc123",port:5656,path:"/send",method:"POST"}),x$=comm,x$.on("receive",function(n){return console.log("I received following data: ",n)}),x$.on("error",function(n){return console.log("COMM-ERR::: ",n.message)}),x$.on("connect",function(n){return console.log("Connected to server!!! Server info: ",n)}),x$.on("disconnect",function(){return console.log("Disconnected from server!")}),x$.on("code",function(n){return console.log("Code is : ",n)}),comm.connect(function(){return sleep(2e4,function(){return function lo(op){return loadCode?(console.log("Evaling code,,"),eval(loadCode)):lo(op)}(function(){}),console.log("following code is starting..."),sleep(1e3,function(){return function n(o){return comm.send({temperature:Math.random()},function(e){return e&&console.log("We couldn't send data!"),timeoutWaitFor(1e4,"temperature-measured",function(){return n(o)})})}(function(){})})})})})};
