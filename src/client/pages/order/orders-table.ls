require! 'aea': {sleep, unix-to-readable, merge}
require! 'prelude-ls': {sum, split, sort-by, flatten, group-by, reverse }
require! './utilities': {get-production-items, get-material-usage}
    ...
    settings:
        ...
        handlers:
            ...
            send-to-production: (orders-to-produce) ->
                ...
                #console.log "Stock materials are: ", stock-materials

                material-usage = get-material-usage (get-production-items [.. for tabledata when .._id in order-list]), recipes, stock-materials
    ...
    settings:
        ...
        filters:
            all: (docs) ->
                ...
                recipes = __.get \recipes
                stock-materials = __.get \stock-materials
                x = get-material-usage (get-production-items production-list), recipes, stock-materials
