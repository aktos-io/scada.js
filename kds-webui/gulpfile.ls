...
gulp.task \default, ->
    ...
    watch "#{client-src}/components/**/*.*", (event) ->
        gulp.start 'js'
...
gulp.task \generate-components-module ->
    glob "#{components-src}/*", (err, filepath) ->
        ...
        fs.write-file main, '# Do not edit this file manually! \n'

        for c in components
            console.log "Adding component livescript file: ", c
            fs.append-file main, "require! './#{c}'\n"

        fs.append-file main, "module.exports = { #{join ', ', components} }\n"
